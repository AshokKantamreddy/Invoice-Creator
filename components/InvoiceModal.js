...
import {creteInvoice} from "../actions/invoiceAction"
...
sendInvoice=()=>
  ...
  render() {
    console.log(" chickiing in model props",this.props)
    return(
      <div>
        <Modal show={this.props.showModal} onHide={this.props.closeModal} size="lg" centered>
          ...
          <div className="pb-4 px-4">
            <Row>
              <Col md={6}>
                <Button variant="primary" className="d-block w-100" onClick={()=>{this.props.creteInvoice(this.props)}}>
...
const  mapStateToProps=(state)=>(
  {
    listOfinvoice:state.invoice.listOfinvoices
  }
)
